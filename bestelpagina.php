               ...
               <div class="container-controle">
                  ...
                  <div class="tekstding">
                     ...
                     <div class="controle-bestelling-container">
                        ...
                        <div class="start-time">Wanneer: <span></span></div>
...
<script>
   ...
   tijdElement.addEventListener('change', updateText);
   ...
   function updateText(){
      const datumText = datumsElement.value;
      const tijdSelected = tijdElement.value;
      const tijdText = tijdElement.options[tijdElement.selectedIndex]?.text || '';

      document.querySelector('.start-time span').innerText = datumText + ' ' + tijdText;
   }
